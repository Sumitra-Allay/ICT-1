...
days_borrowed = int(input("Enter the number of days borrowed"))
...
if days_borrowed > 30:
    warning_message = "Library privilege may be restricted"


print("  LIBRARY REPORT")
print("Student Name: {student name}")
print(f"Days Borrowed: Borrowed: {days_borrowed}")
